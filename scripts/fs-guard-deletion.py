...
#: binary), and every reddened test when none does.  Suites gate2, gate3, gate4, gate5 and gate9-epoch-change were
#: measured by run `fsdisc-b21c` and then re-run in full with these entries in
#: force by run `fsver-3d8e`, in which every case was classified plain `RED` --
