...
WITNESSES: dict[tuple[str, str], frozenset[str]] = {
    ...
    ('m5c3', 'typed text is redacted from every diagnostic'): frozenset({'crates/tunnel-cua/src/schema.rs - schema::Keystrokes (line 122)', 'plan::tests::the_validated_parameters_never_render_the_typed_text'}),
    ...
    ('m5c7', 'the scroll deltas may be dropped for the cursor point'): frozenset({'plan::tests::every_input_operation_plans_its_canonical_command_and_payload'}),
